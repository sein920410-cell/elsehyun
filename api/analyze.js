...
[개인정보 보호 — 절대 필수] 아래 목록 중 하나라도 사진·영상에 보이면 items를 반드시 빈 배열([])로 반환하고 reasoning 첫 줄을 반드시 "PRIVATE_INFO_DETECTED: [감지된 항목명만 간결하게, 예: 신용카드, 이메일주소 노출]"로 시작할 것. 위치·방향 설명 없이 항목 종류만 기재.
    차단 대상 문서·정보:
