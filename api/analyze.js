...
3. 라벨 없으면 색상+형태 설명만. 예: "흰색 직사각형 플라스틱 통"
4. 절대 "이 공간에 있을 법한" 물건을 상상해서 추가하지 않는다.
5. 여러 개면 (×N개) 표시.
6. JSON 아님, 번호 목록으로만 응답.`;
...
- 라벨 없으면: 한국어 형태 설명 (예: "흰색 플라스틱 바구니", "접이식 의자")
- 영양제: 라벨 성분명 그대로 (아르기닌≠비타민, 오메가3≠비타민, 콜라겐≠비타민)
- 신발: "슬리퍼", "운동화", "샌들" 등 실제 보이는 형태로
- 세제: 라벨 읽은 것만, 보이지 않으면 "세탁세제" 아닌 "흰색 세제 용기"
