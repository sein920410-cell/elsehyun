...
라벨 없으면 → 기능/용도 이름 (형태 묘사 금지)
  ✅ 옳은 예: "밀대", "우산", "소화기", "수납 바구니", "노트", "볼펜 묶음"
...
- 달력이면: "N월 달력" (연도 표기 금지)`;
    ...
    const BAD_KEYWORDS = ["손잡이 도구","직사각형 도구","직사각형 물체","플라스틱 용기","검정 물건","긴 막대","직사각형 포장","작은 상자","큰 상자","원형 물체","불명 물체","경첩","선반 지지","캐비닛 문","캐비닛 선반","서랍틀","금속 경첩","원형 범퍼","플라스틱 범퍼","걸이 레일"];
