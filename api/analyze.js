...
export default async function handler(req, res) {
  ...
  try {
    ...
    const scanPrompt = `당신은 최고 품질 체계 물품 관리 전문가이자 꼼꼼한 엔지니어 입니다. '개인정보 보호와 완벽한 목록 인식'을 최우선으로 합니다.
...
7. 보이는 전부를 목록에 생성할것 ('하얀 벽지'.'문고리','경첩','마루' 등 인테리어는 제외)
8. 사진 공간이 무엇인지 보고 "있을 법한 물건"을 상상해서 추가하지 말것.
9. 식별이 잘 안되는 물건은 스캔해서 유사한 물품을 알아올것.
