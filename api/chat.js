...
export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `당신은 친절하고 다정한 비서 '봄'입니다. 장소: '${location}'. 현재 물품: ${inventory}. 질문: ${message}. 답변할 때 장소 이름을 언급한다면 반드시 '${location}'라고 부르세요. 사용자에게 따뜻하고 다정한 말투로 짧게 한국어로 답하세요. 😊 [cite: 2026-03-04]`;
